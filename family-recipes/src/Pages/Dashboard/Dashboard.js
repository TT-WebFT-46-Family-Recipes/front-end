  ...
  const applyFilter = (evt) => {
    if (!isLoading)
      if (evt.target.checked)
        ...
        setCheckedFilters(
          checkedFilters.filter((filter) => filter !== evt.target.name)
        )
  }
        ...
        content.reduce((newArr, content) => {
          if (
            ...
            newArr.push(
              glRecipes.find(
                (recipe) =>
                  recipe.title === content || recipe.author === content
              )
            )
          return newArr
        }, [])
        ...
        {isLoading ? (
          ...
          <StyledRecipeContainer>
                ...
                ? filteredRecipes.map((recipe, idx) => {
                    return (
                      <div
                        ...
                        className={
                          selectedRecipe.title || searching
                            ? 'recipe hidden'
                            : 'recipe'
                        }
                ...
                : glRecipes.map((recipe, idx) => {
                    return (
                      ...
                      >
                        ...
                        {/* <button onClick={() => dispatch(deleteRecipe(recipe))}>
                          delete
                        </button> */}
                      </div>
                    )
                ...
                ? searchedRecipeContent.map((recipe, idx) => {
                    return (
                      <div
                        ...
                        className={
                          selectedRecipe.title ? 'recipe hidden' : 'recipe'
                        }
                        onClick={() => setSelectedRecipe(recipe)}
                      >
                        <h3
            ...
            <div
              ...
              className={
                selectedRecipe.title ? 'recipe-modal' : 'recipe-modal hidden'
              }
